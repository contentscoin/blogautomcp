...
const TOOLS = [
  ...
  },
  {
    ...
    description: '초안 생성 2단계입니다. 쇼핑은 상세이미지에서 직접 확인한 evidenceFacts와 함께 제목·본문 섹션·해시태그를 PC에 보내 품질 검증 후 승인 대기 초안 패키지로 저장합니다. 완료 작업을 job_get으로 확인하고 contentQuality.canPublish가 false이면 실패 사유를 반영해 보강 제출해야 합니다. 발행하지는 않습니다.',
    inputSchema: {
      type: 'object',
      properties: {
        ...
        draft: {
          ...
          properties: {
            ...
            evidenceFacts: { type: 'array', minItems: 0, maxItems: 12, uniqueItems: true, items: { type: 'string', minLength: 4, maxLength: 220 }, description: '상품 상세페이지 이미지나 검증된 상품 정보에서 직접 확인한 제품 고유 수치·기능·구성입니다.' },
