...
export default async function Home() {
  ...
  const windowsDownloadHref = user
    ? '/api/download/windows'
    : chatGPTSignInPath('/api/download/windows');
  const macosDownloadHref = user
    ? '/api/download/macos'
    : chatGPTSignInPath('/api/download/macos');
    ...
    <main className="landing-shell product-landing">
      <nav className="nav shell">
        ...
        <div className="nav-actions">
          ...
          <a className="button button-small button-primary" href={windowsDownloadHref}>Windows 앱</a>
          <a className="button button-small button-ghost" href={macosDownloadHref}>macOS 앱</a>
      ...
      <section className="lp-hero shell">
        ...
        <div className="lp-hero-copy">
          ...
          <div className="hero-actions">
            ...
            <a className="button button-ghost" href={windowsDownloadHref}><span aria-hidden="true">↓</span> Windows 앱</a>
            <a className="button button-ghost" href={macosDownloadHref}><span aria-hidden="true">↓</span> macOS 앱</a>
