...
const CATEGORY_INSTRUCTIONS: Record<string, string> = {
  ...
  sceneLinkage: "서로 다른 저장 출처 사실을 각각 별도의 완결 문장으로 사용 장면의 이점 또는 제약과 연결하세요. 검사 근거에 나온 판단 문장 수와 서로 다른 근거 수를 모두 채우세요. 한 문장에 사실 두 개만 나열하면 판단 두 개가 되지 않습니다. 각 판단 문장에 해당 사실을 직접 쓰거나, 같은 문단의 바로 앞 사실 문장을 받아 설명하세요. 출처에 없는 기능은 추가하지 마세요.",
