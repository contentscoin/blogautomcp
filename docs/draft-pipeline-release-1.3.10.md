...
- 공개 Sites 서버는 후속 사용자 승인("사이트도 적용해줘")을 받은 뒤 1.3.10을 적용했다. 저장된 소스 `9afd398be831c28b88b791c75cee2f82f5361f41`의 배포가 2026-09-03 05:16:57 UTC에 succeeded로 완료됐다. 공개 홈페이지 및 OAuth 메타데이터 HTTP 200, 연결된 PC의 MCP agent_get_status 온라인 응답을 확인했다. PC 설치 버전은 여전히 1.3.9이며 사이트 배포와 구분한다.
